...
public class InputAdapter {
        ...
        public static String[][] Choices = {
                        { "een", "ONE", "One", "one", "1", "Een", "EEN", "top left", "topleft", "TOPLEFT", "TOP LEFT",
                                        "Top Left",
                                        "Topleft", "Top left" },
                        { "twee", "TWO", "Two", "two", "2", "Twee", "TWEE", "top middle", "topmiddle", "TOPMIDDLE",
                                        "TOP MIDDLE",
                                        "Top Middle", "Topmiddle", "Top middle" },
                        { "drie", "THREE", "Three", "three", "3", "Drie", "DRIE", "top right", "topright", "TOPRIGHT",
                                        "TOP RIGHT",
                                        "Top Right", "Topright", "Top right" },
                        { "vier", "FOUR", "Four", "four", "4", "Vier", "VIER", "middle left", "middleleft",
                                        "MIDDLELEFT",
                                        "MIDDLE LEFT", "Middle Left", "Middleleft", "Middle left" },
                        { "vijf", "FIVE", "Five", "five", "5", "Vijf", "VIJF", "middle", "MIDDLE", "Middle", "MIDDLE",
                                        "Middle",
                                        "Middle", "Middle" },
                        { "zes", "SIX", "Six", "six", "6", "Zes", "ZES", "middle right", "middleright", "MIDDLERIGHT",
                                        "MIDDLE RIGHT", "Middle Right", "Middleright", "Middle right" },
                        { "zeven", "SEVEN", "Seven", "seven", "7", "Zeven", "ZEVEN", "bottom left", "bottomleft",
                                        "BOTTOMLEFT",
                                        "BOTTOM LEFT", "Bottom Left", "Bottomleft", "Bottom left" },
                        { "acht", "EIGHT", "Eight", "eight", "8", "Acht", "ACHT", "bottom middle", "bottommiddle",
                                        "BOTTOMMIDDLE",
                                        "BOTTOM MIDDLE", "Bottom Middle", "Bottommiddle", "Bottom middle" },
                        { "negen", "NINE", "Nine", "nine", "9", "Negen", "NEGEN", "bottom right", "bottomright",
                                        "BOTTOMRIGHT",
